...
| [IP Restriction](https://github.com/bestofthebestbabe/x-ui/#enable-ip-restrictions-per-inbound) | :heavy_check_mark: |
| [Inbound Multi User](https://github.com/bestofthebestbabe/x-ui/#enable-multi-user-traffic--exprire-day) | :heavy_check_mark: |
| [Multi User Traffic & expire day](https://github.com/bestofthebestbabe/x-ui/#enable-multi-user-traffic--exprire-day) | :heavy_check_mark: |
| [REST API](https://github.com/bestofthebestbabe/x-ui/pull/51) | :heavy_check_mark: |
| [Telegram BOT](https://github.com/bestofthebestbabe/x-ui/pull/110) | :heavy_check_mark: |
...
```
bash <(curl -Ls https://raw.githubusercontent.com/bestofthebestbabe/x-ui/master/install.sh)
```

## Manual install & upgrade

1. First download the latest compressed package from https://github.com/bestofthebestbabe/x-ui/releases , generally choose Architecture `amd64`
...
> This docker tutorial and docker image are provided by [bestofthebestbabe](https://github.com/bestofthebestbabe)
...
[![Stargazers over time](https://starchart.cc/bestofthebestbabe/x-ui.svg)](https://starchart.cc/bestofthebestbabe/x-ui)
