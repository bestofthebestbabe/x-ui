...
func (s *ServerService) GetXrayVersions() ([]string, error) {
	url := "https://api.github.com/repos/bestofthebestbabe/Xray-core/releases"
...
func (s *ServerService) downloadXRay(version string) (string, error) {
	...
	url := fmt.Sprintf("https://github.com/bestofthebestbabe/Xray-core/releases/download/%s/%s", version, fileName)
	resp, err := http.Get(url)
	if err != nil {
		return "", err
	}
